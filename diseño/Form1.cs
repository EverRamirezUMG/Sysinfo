...
namespace diseño
{
    public partial class Form1 : Form
    {
        ...
        {
            Process p = Process.Start("winver");
        }
        ...
        {
            Process p = Process.Start("tasklist");
        }
        ...
        {
            Process p = Process.Start("netstat");
        }
        ...
        {
            Process p = Process.Start("perfmon");
        }
        ...
        {
            Process p = Process.Start("appwiz.cpl");
        }

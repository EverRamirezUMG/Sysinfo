...
namespace diseño
{
    public partial class DxDiag : Form
    {
        ...
        {
            if(comboBox2.SelectedItem.ToString() == "PARTICIONES")
                MuestraInformacion("Win32_DiskPartition", listView9);
            if (comboBox2.SelectedItem.ToString() == "BIOS")
                MuestraInformacion("Win32_BIOS", listView9);
            if (comboBox2.SelectedItem.ToString() == "CACHÉ")
                MuestraInformacion("Win32_CacheMemory", listView9);
            if (comboBox2.SelectedItem.ToString() == "IMPRESORAS")
                MuestraInformacion("Win32_Printer", listView9);
        }
